    ...
    <div class="w-full lg:min-w-xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <div @click="demo = !demo" x-data="{ demo: false }"
            ...
            <div x-show="demo" x-cloak
                class="bg-white absolute right-0 left-0 top-full mt-2 border border-border rounded-lg shadow-lg px-3 py-4 z-60 h-32 overflow-y-auto">
                <button type="button" class="flex items-center gap-3 border-b pb-3 border-muted-gray w-full text-left"
                    @click.stop wire:click="$set('email', 'admin@admin.com'); $set('password', 'password')">
                    <div>
                ...
                <button type="button"
                    class="flex items-center gap-3 border-b pb-3 border-muted-gray w-full text-left" @click.stop
